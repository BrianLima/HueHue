...
namespace HueHue.Views
{
    ...
    /// </summary>
    public partial class MusicModeEqualizer : UserControl
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            values = Mode.IncreaseVariance(values);

            Mode.Colors[0] = LEDBulb.Subtract(values[0], LEDBulb.ColorPropertyType.Saturation, original_colors[0]);
            Mode.Colors[1] = LEDBulb.Subtract(values[1], LEDBulb.ColorPropertyType.Saturation, original_colors[1]);
            Mode.Colors[2] = LEDBulb.Subtract(values[2], LEDBulb.ColorPropertyType.Saturation, original_colors[2]);
            Mode.Colors[3] = LEDBulb.Subtract(values[3], LEDBulb.ColorPropertyType.Saturation, original_colors[3]);
            Mode.Colors[4] = LEDBulb.Subtract(values[4], LEDBulb.ColorPropertyType.Saturation, original_colors[4]);
            Mode.Colors[5] = LEDBulb.Subtract(values[5], LEDBulb.ColorPropertyType.Saturation, original_colors[5]);
            Mode.Colors[6] = LEDBulb.Subtract(values[6], LEDBulb.ColorPropertyType.Saturation, original_colors[6]);
            Mode.Colors[7] = LEDBulb.Subtract(values[7], LEDBulb.ColorPropertyType.Saturation, original_colors[7]);
